...
public class GuestGames implements Initializable {
    ...
    public void SwitchToScene5(ActionEvent event) throws IOException {
        root = FXMLLoader.load(getClass().getResource("GuestFood.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
    ...
    public void insertGames() throws SQLException, ClassNotFoundException {
        ...
        if(pc1CB.isSelected()){
            HelloApplication.reserseGameNumGuest++;
    ...
    public void endSessionFunction(ActionEvent event) throws SQLException, ClassNotFoundException, IOException {
        ...
        HelloApplication.reserveGameTimeGuest = toHours;
        ...
        HelloApplication.reserveGameTotalGuest = total;
